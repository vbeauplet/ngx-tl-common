 ...
 */
@Component({
  selector: 'tls-tree-node',
  templateUrl: './tl-tree-node.component.html',
  styleUrls: ['./tl-tree.component.scss'],
})
export class TlsTreeNodeComponent implements OnInit {

  /**
   * Children tree node components
   */
  @ViewChildren(TlsTreeNodeComponent) childrenTreeNodes: QueryList<TlsTreeNodeComponent>;
  ...
  public unwrapChildren(recursive: boolean) {
    this.childrenTreeNodes.forEach((child: TlsTreeNodeComponent) => {
...
export class TlsTreeComponent implements OnInit, OnChanges {
