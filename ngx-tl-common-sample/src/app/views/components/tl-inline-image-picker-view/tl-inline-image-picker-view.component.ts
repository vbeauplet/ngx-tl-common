...
@Component({
  ...
  host: { 'class' : 'tls-page'},
  templateUrl: './tl-inline-image-picker-view.component.html',
  styleUrls: ['./tl-inline-image-picker-view.component.css']
})
export class TlInlineImagePickerViewComponent implements OnInit {
